...
export default function HomePage() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif", background: '#f8f9fa', minHeight: '100vh' }}>

      {/* HERO */}
      <section style={{ position: 'relative', background: 'linear-gradient(150deg, #022c22 0%, #064e3b 45%, #065f46 75%, #0a7050 100%)', padding: '80px 24px 100px', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', inset: 0, backgroundImage: 'radial-gradient(circle at 20% 50%, rgba(16,185,129,0.15) 0%, transparent 50%), radial-gradient(circle at 80% 20%, rgba(110,231,183,0.1) 0%, transparent 40%)', pointerEvents: 'none' }} />
      ...
      <section style={{ maxWidth: '1200px', margin: '0 auto', padding: '64px 24px 0' }}>
        <p style={{ margin: '0 0 6px', fontSize: '13px', fontWeight: 700, color: '#10B981', textTransform: 'uppercase', letterSpacing: '1px' }}>Browse</p>
          ...
          {DESTINATIONS.map((d, i) => (
            <div key={d.city} onClick={() => navigate('/listings?location=' + d.city)}
              ...
              <div style={{ position: 'absolute', bottom: '18px', left: '20px' }}>
                ...
                <span style={{ background: 'rgba(255,255,255,0.2)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.3)', borderRadius: '20px', padding: '3px 10px', fontSize: '11px', color: '#fff', fontWeight: 600 }}>{d.count}</span>
              </div>
            </div>
          ))}
        </div>
      ...
      <section style={{ background: '#fff', borderTop: '1px solid #f0f0f0', padding: '80px 24px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '56px' }}>
            <p style={{ margin: '0 0 8px', fontSize: '13px', fontWeight: 700, color: '#10B981', textTransform: 'uppercase', letterSpacing: '1px' }}>Simple process</p>
      ...
      <section style={{ background: '#f0fdf4', padding: '64px 24px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <p style={{ margin: '0 0 8px', fontSize: '13px', fontWeight: 700, color: '#10B981', textTransform: 'uppercase', letterSpacing: '1px' }}>Our promise</p>
            ...
            {REVIEWS.map(r => (
              <div key={r.name} style={{ background: '#fafafa', borderRadius: '20px', padding: '28px', border: '1px solid #f0f0f0' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <div style={{ width: '42px', height: '42px', borderRadius: '50%', background: 'linear-gradient(135deg, #064e3b, #10B981)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 800, fontSize: '13px' }}>{r.avatar}</div>
                  <div>
      ...
      <footer style={{ background: '#0a0a0a', padding: '48px 24px 32px' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingBottom: '32px', borderBottom: '1px solid #1a1a1a', flexWrap: 'wrap', gap: '20px' }}>
            <div>
              <p style={{ margin: '0 0 4px', fontSize: '22px', fontWeight: 800, color: '#10B981' }}>DIAVELA</p>

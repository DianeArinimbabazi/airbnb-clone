    ...
    <div className="auth-split" style={{ background:bg }}>
      <div className="auth-form-panel" style={{ background:card, padding:"48px", display:"flex", flexDirection:"column", justifyContent:"center" }}>
        <div style={{ marginBottom:"32px" }}>
          ...
          <h2 style={{ fontSize:"28px", fontWeight:700, margin:"0 0 12px" }}>
            <em style={{ fontStyle:"italic", color:"#FF385C" }}>Sign in</em> to continue.
          </h2>
          <p style={{ fontSize:"13px", color:sub, margin:0, lineHeight:1.6 }}>Access your account to manage bookings, listings, and more.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display:"flex", flexDirection:"column", gap:"16px" }}>
          <div>
            <label style={lbl}>Enter Email <span style={{ color:"#FF385C" }}>*</span></label>
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="you@example.com" required style={inp} />
          </div>
          <div>
            <label style={lbl}>Password <span style={{ color:"#FF385C" }}>*</span></label>
          ...
          <div style={{ textAlign:"right", marginTop:"4px" }}>
            <Link to="/forgot-password" style={{ fontSize:"13px", color:"#FF385C", textDecoration:"none", fontWeight:600 }}>Forgot password?</Link>
          </div>
          </div>
        ...
        <p style={{ textAlign:"center", marginTop:"20px", fontSize:"14px", color:sub }}>
          No account? <Link to="/signup" style={{ color:"#FF385C", fontWeight:600 }}>Sign up</Link>
        </p>
      </div>
      ...
      <div className="auth-right-panel" style={{ background:rightBg, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:"48px", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ textAlign:"center", maxWidth:"360px", position:"relative", zIndex:1 }}>
          <h2 style={{ fontSize:"26px", fontWeight:700, color:text, marginBottom:"12px" }}>Effortlessly find your perfect stay.</h2>
          <p style={{ fontSize:"14px", color:sub, marginBottom:"40px", lineHeight:1.7 }}>Browse hundreds of listings, connect with hosts, and manage your bookings all in one place.</p>
